...
export const Icons = {
  ...
  supabase: (props: IconProps) => (
    <svg viewBox="0 0 109 113" className="h-12 w-12 fill-current" {...props}>
      <path
  ...
  prisma: (props: IconProps) => (
    <svg
      viewBox="0 0 159 195"
      className="h-12 w-12 fill-[#2D3748] dark:fill-white"
      {...props}
    >
      <path
        fillRule="evenodd"
  ...
  shadcn: (props: IconProps) => (
    <svg viewBox="0 0 256 256" className="h-12 w-12 fill-current" {...props}>
